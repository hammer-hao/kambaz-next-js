...
export default function AssignmentEditor() {
    ...
    useEffect(() => {
        if (!isNew && !existing) router.push(`/Courses/${cid}/Assignments`);
    }, [isNew, existing, cid, router]);
    ...
    const onSave = () => {
        ...
        if (isNew) dispatch(addAssignment(payload));
        else dispatch(updateAssignment(payload));
        ...
        <div id="wd-assignments-editor" className="p-3">
            <Form>
                ...
                <Form.Group as={Row} className="mb-3" controlId="wd-points">
                    <Form.Label column md={3} className="fw-semibold text-md-end">Points</Form.Label>
                    <Col md={9}>
                        <Form.Control
                            type="number"
                            value={points}
                ...
                <Form.Group as={Row} className="mb-3" controlId="wd-group">
                    <Form.Label column md={3} className="fw-semibold text-md-end">Assignment Group</Form.Label>
                    <Col md={9}>
                ...
                <Form.Group as={Row} className="mb-3" controlId="wd-display-grade-as">
                    <Form.Label column md={3} className="fw-semibold text-md-end">Display Grade as</Form.Label>
                    <Col md={9}>
                ...
                <Form.Group as={Row} className="mb-4" controlId="wd-submission-type">
                    <Form.Label column md={3} className="fw-semibold text-md-end">Submission Type</Form.Label>
                    <Col md={9}>
                ...
                <Form.Group as={Row} className="mb-4">
                    <Form.Label column md={3} className="fw-semibold text-md-end">Assign</Form.Label>
                    <Col md={9}>
                        <Card className="border">
                            <Card.Body>
